...
- Configure your network architecture: right click on your project "Preesm > generate custom architecture network". Choose the network you want. You can let it as default. It generates a XML file store in the **Archi** folder (you can update it as you want)
...
```
- Launch `jupyter notebook` and open "SimSDPproject/SimulationAnalysis.ipynb".
